...
# export LASER="/mnt/c/Users/LI/Desktop/UNIWORK/MASTERS/THESIS/LASER/LASER"
# bash ./LASER/tasks/embed/embed.sh ./LASER/tasks/embed/input.txt ./LASER/tasks/embed/output.bin

# location of models (e.g. /path/to/models); no trailing slash
model_dir="/mnt/c/Users/LI/Desktop/UNIWORK/MASTERS/THESIS/misinfo-eng-est/models/laser2"
